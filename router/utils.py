...
def get_config():
    return {
        ...
        "report_worker_enabled": os.getenv("REPORT_WORKER_ENABLED", "true").lower() == "true",
        "report_worker_poll_seconds": int(os.getenv("REPORT_WORKER_POLL_SECONDS", "5")),
        "report_job_max_attempts": int(os.getenv("REPORT_JOB_MAX_ATTEMPTS", "3")),
        "report_job_backoff_seconds": int(os.getenv("REPORT_JOB_BACKOFF_SECONDS", "30")),
        "report_idempotency_ttl_seconds": int(os.getenv("REPORT_IDEMPOTENCY_TTL_SECONDS", "1209600")),
